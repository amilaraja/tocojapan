...
<x-layouts.site :title="$title">
    <section class="bg-gradient-to-b from-toco-navy to-toco-navy-deep text-white">
        <div class="w-full px-6 2xl:px-8 py-10">
            <p class="font-mono text-[11px] uppercase tracking-[0.2em] text-toco-red font-bold">My Toco</p>
            <h1 class="text-2xl md:text-3xl font-extrabold mt-1">Welcome back, {{ Auth::user()->name }}.</h1>
            <p class="text-white/70 text-sm mt-1">Track your saved vehicles, your active quotes, and your account in one place.</p>
        </div>
    </section>
